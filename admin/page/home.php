...
$sudah = mysqli_query($con, "SELECT * FROM (( request 
				        	INNER JOIN penduduk ON request.id_penduduk = penduduk.id_penduduk) 
				        	INNER JOIN surat ON request.id_surat = surat.id_surat ) WHERE request.status = 1 ORDER BY id_req DESC LIMIT 10") ;
?>
<div class="row">
	<div class="col-md-12">
		<div class="card">
				...
				<table class="table table-hover table-bordered" id="table">
					...
					<?php 
						if (mysqli_num_rows($belum) == 0 ) {
						 	echo "<tr><td colspan='100%'>Tidak Ada Permohonan Surat Yang Belum Diporses.</td></tr>";
						 } else{
						$no = 1;
...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<h4 class="card-header bg-success text-white">Data Permohonan Surat Sudah Di Proses</h4>
			<div class="card-body">
